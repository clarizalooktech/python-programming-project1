...
Issue in my program:
- I was NOT able to compute the last figure of the correlation which should output a `1`.
- I was not able to include error checking features as I lacked time
- I know my programming style is not efficient but I will practice more
 '''
